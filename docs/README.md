...
The deployment url is: [https://arquisoft.github.io/wichat_en2a/](https://arquisoft.github.io/wichat_en2a/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wichat_en2a/](https://arquisoft.github.io/wichat_en2a/), we need to execute `npm run deploy`.
