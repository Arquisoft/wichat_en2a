...
const Game = () => {
    ...
    const retrieveHint = async () => {
        try {
            const response = await axios.post(`${apiEndpoint}/askllm`, {
                question: question.correctAnswer, model: "empathy"
            });
    ...
    if (loading) {
        return (
            ...
            >
                <Typography
                    component="h1" variant="h4" sx={{mb: '2rem'}}
                >
                    Quiz Game!
                </Typography>
                <CircularProgress/>
        ...
        <>
            ...
            >
                    ...
                    >
                        ...
                        <Box
                            ...
                            {question.options.map((option, index) => (
                                <Button
                                    key={index} variant="contained" fullWidth sx={{
                                        mb: '0.5rem',
                                        py: '1rem'
                                    }}
                ...
                <Box sx={{mt: '0.5rem', display: 'flex', justifyContent: 'flex-start', width: '100%'}}>
                    ...
                    <Button
                        variant="contained" color="primary" disabled={!answerSelected} onClick={fetchQuestion}
                            sx={{ml: '1rem'}}>
                        Next Question
                    </Button>
                </Box>
