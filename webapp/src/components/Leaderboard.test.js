...
const Leaderboard = () => {
    ...
    if (loading) return (
        <>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', height: '50vh', mt: 8 }}>
                <CircularProgress size={60} thickness={4} sx={{ color: '#6A5ACD' }} role="progressbar" />
    ...
    // Show a message if no player data is available
    if (players.length === 0) {
        return (
            <>
                <Navbar />
                                ...
                                {paginatedPlayers.map((player, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{player.avgPointsPerGame != null ? player.avgPointsPerGame.toFixed(2) : 'N/A'}</TableCell>
                ...
                {currentUser && (
                    ...
                    >
                        <TableRow sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <TableCell sx={{ flex: 1, border: 'none', padding: 1, color: 'white', textAlign: 'right' }}>
                                {currentUser.avgPointsPerGame != null ? currentUser.avgPointsPerGame.toFixed(2) : 'N/A'}
                            </TableCell>
